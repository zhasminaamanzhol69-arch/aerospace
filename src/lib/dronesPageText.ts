...
export const dronesPageText: Record<Language, DroneCopy> = {
  ru: {
    ...
    heroBody: 'Раздел посвящён UAV-сценариям для поиска, доставки, мониторинга пожаров и восстановления связи при чрезвычайных ситуациях.',
    back: 'Назад',
    mission: 'Миссия',
    ...
    drones: [
      ['Поисково-спасательный Fixed Wing', 'Большой район поиска, лес, степь, горы', 'Тепловизор, RGB-камера, радиомаяк', 'Дальность и длительное патрулирование', 'Нужна площадка или катапульта для старта'],
      ...
      ['VTOL Rescue Hybrid', 'Смешанный маршрут: дальний перелёт и точная посадка', 'Аптечка, маяк, камера, малый груз', 'Компромисс дальности и вертикального старта', 'Сложнее конструкция и обслуживание'],
    ...
    checks: ['Проверить ветер, осадки и видимость.', 'Подтвердить заряд и резерв возврата.', 'Проверить крепление нагрузки и центр масс.', 'Настроить fail-safe: RTH, посадка или удержание точки.', 'Записать телеметрию миссии.'],
  },
  kk: {
