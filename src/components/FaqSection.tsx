...
const text: Record<Language, {
  ...
  kk: {
    ...
    items: [
      { question: 'Бұл агент аппараттарға көмектесе ме?', answer: 'Тікелей емес. Ол ұшу аппараттарын жобалайтын инженерлерге, студенттерге және командаларға көмектеседі.' },
      ...
      { question: 'Бұл аппараттар ғарыш үшін жасалған ба?', answer: 'Аэроғарыш саласы авиацияны да, ғарышты да қамтиды. Қазір есеп БПЛА арқылы көрсетілген, бірақ логиканы спутниктерге және ғарыш аппараттарына кеңейтуге болады.' },
      ...
      { question: 'Агент жобалау кезеңінде параметрлерді қалай есептейді?', answer: 'Пайдалы жүк, ұшу массасы, миссия ұзақтығы және аппарат схемасы арқылы масса, қуат, энергия, геометрия, аэродинамикалық сапа және беріктік қорын бағалайды.' },
      ...
      { question: 'Цифрлық егіз телеметрияны талдауға қалай көмектеседі?', answer: 'Цифрлық егіз аккумулятор күйі, температура, байланыс сигналы, кідіріс, діріл және жұмыс уақыты бойынша аппараттың күйін бақылап, ақау мен техникалық қызмет қажеттілігін алдын ала көрсетеді.' },
    ],
  ...
  ru: {
    ...
    items: [
      ...
      { question: 'Эти аппараты созданы для космоса?', answer: 'Аэрокосмическая область включает и авиацию, и космос. В текущем прототипе расчёт показан на примере БПЛА, но такую же логику можно расширить для спутников, посадочных модулей и космических аппаратов.' },
      { question: 'В чём суть ИИ-агента?', answer: 'Он превращает начальные требования в инженерный анализ: рассчитывает параметры, сравнивает варианты, показывает риски и предлагает решение.' },
      { question: 'Как агент рассчитывает параметры на этапе проектирования?', answer: 'Он использует полезную нагрузку, взлётную массу, длительность миссии, схему аппарата и ограничения, чтобы оценить массу, мощность, энергию, геометрию, аэродинамическое качество и запас прочности.' },
      ...
      { question: 'Как цифровой двойник помогает в эксплуатации и анализе телеметрии?', answer: 'Цифровой двойник связывает аппарат, поток телеметрии и прогноз ИИ: отслеживает состояние аккумулятора, температуру, сигнал связи, задержку, вибрацию и остаточный ресурс до ТО.' },
    ],
    proTitle: 'Pro версия',
